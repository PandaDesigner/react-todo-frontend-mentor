...
export const FilterSection = ({ handlerFilterTodo }) => {
  return (
    <>
      <section className="container sticky px-4 pt-2 pb-8 mx-auto transition-colors duration-700 sm:mt-6 sm:pt-4 sm:relative bg-slate-300 dark:bg-slate-900 bottom-6">
